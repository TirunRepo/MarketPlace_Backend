...
namespace MarketPlace.Business.Services.Promotions
{
    public class PromotionService : IPromotionService
    {
        ...
        {
            var entity = _mapper.Map<PromotionModel>(promotion);
        ...
        public List<PromotionModel> GetFilteredRecords(List<PromotionModel> promotions, PromotionCalculationType promotionCalculation)
        {
            var filteredResponse = new List<PromotionModel>();
        ...
        public List<PromotionCalculationResponse> ProcessResponse(List<PromotionModel> promotions, PromotionCalculationRequest request, PromotionCalculationType promotionCalculation)
        {
        ...
        public PromotionCalculationResponse GetPromotionDetails(PromotionModel promotionModel, PromotionCalculationRequest request)
        {
        ...
        public List<PassengerDetails> MapPassengers(List<PassengerRequestModel> passengers, PromotionModel promotionModel, bool isChildDiscount = false, int? passangerIndex = null)
        {
        ...
        public PromotionCalculationResponse GetPromotionDetailsForCombo(PromotionModel promotionModel, PromotionCalculationRequest request)
        {
            decimal discount = 0;
        ...
        public PromotionCalculationResponse GetPromotionDetailsForAdultDiscount(PromotionModel promotionModel, PromotionCalculationRequest request)
        {
            decimal discount = 0;
            if (promotionModel.MinNoOfAdultRequired <= request.Passengers.Count(x => x.Age >= 18) &&
                promotionModel.MinNoOfChildRequired <= request.Passengers.Count(x => x.Age < 18)
        ...
        public PromotionCalculationResponse GetPromotionDetailsForChildDiscount(PromotionModel promotionModel, PromotionCalculationRequest request)
        {
            decimal discount = 0;
            if (promotionModel.MinNoOfAdultRequired <= request.Passengers.Count(x => x.Age >= 18) &&
                promotionModel.MinNoOfChildRequired <= request.Passengers.Count(x => x.Age < 18)
        ...
        public PromotionCalculationResponse GetPromotionDetailsForFreePassengerDiscount(PromotionModel promotionModel, PromotionCalculationRequest request)
        {
            decimal discount = 0;
